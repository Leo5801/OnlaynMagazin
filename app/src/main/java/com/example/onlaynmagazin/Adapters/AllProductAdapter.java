...
public class AllProductAdapter extends RecyclerView.Adapter<AllProductAdapter.ProductViewHolder>  {
    ...
    public ProductViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view=LayoutInflater.from(context).inflate(R.layout.product_layout2,parent,false);
    ...
    public void onBindViewHolder(@NonNull ProductViewHolder holder, int position) {
        ...
        holder.textView2.setText(productarraylist.get(position).getProductprice());
        if (position%2==0){
            holder.imageView.getLayoutParams().height=150;
        }else {
            holder.imageView.getLayoutParams().height=280;
        }
        Glide.with(context)
    ...
    public class ProductViewHolder  extends RecyclerView.ViewHolder {
        ...
        public ProductViewHolder(@NonNull View itemView) {
            ...
            imageView=itemView.findViewById(R.id.imageviewcategoryimage4);
            textView=itemView.findViewById(R.id.textviewcategoryname4);
            linearLayout=itemView.findViewById(R.id.linerlay4);
            textView2=itemView.findViewById(R.id.textviewproductprice);
            button=itemView.findViewById(R.id.buttonbuy);
        }
    }
